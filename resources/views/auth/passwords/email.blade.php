                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="{{ route('password.email') }}" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" id="user-email" placeholder="Your Email Address" required>
                                ...
                                <div class="card-footer border-0">
                                    ...
                                    <p class="float-sm-right text-center">New to Modern ? <a href="/register" class="card-link">Create
                                            Account</a></p>
                                </div>
                            </div>
                        </div>
