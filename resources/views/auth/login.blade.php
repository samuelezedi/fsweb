                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="/login" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="user-name" placeholder="Your Username" name="email" value="{{ old('email') }}" autocomplete="email" autofocus required>
                                    ...
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>New to Modern
                                            ?</span></p>
                                    <div class="card-body">
                                        <a href="/register" class="btn btn-outline-danger btn-block"><i class="la la-user"></i>
                                            Register</a>
                                    </div>
                                </div>
                            </div>
